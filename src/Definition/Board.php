...
class Board implements Action
{
	...
	public function getPaginatedPossibleMovesStringArray(int $offset, int $length): array
	{
		return array_slice($this->getPossibleMoves()->getStringArray(), $offset, $length, true);
	}
